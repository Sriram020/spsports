...
public final class Selection_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 Class.forName("com.mysql.jdbc.Driver");
      ...
      out.write("    <body>\n");
      out.write("        \n");
      out.write("            <form action=\"Selection.jsp\"><select name=\"Sport\">\n");
      ...
      out.write("                    ");
                    ...
                    ResultSet rs=st.executeQuery("select Student_Name,Roll_Number,Phone_Number,DOB,Email,Sport,Status,Level from stureg where Sport='"+sport+"' and Level='"+Level+"'");
                    while(rs.next())
                    {
      ...
      out.write("                </tbody>\n");
      out.write("            </table>\n");
      out.write("                <form action=\"Selection.jsp\">\n");
